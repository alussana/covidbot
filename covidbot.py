...
if __name__ == '__main__':
    ...
    covidbot.plot_cases_by_day('Italy', context="notebook", aspect=2.3)
    covidbot.plot_deaths_by_day('Italy', context="notebook", aspect=2.3)
    covidbot.plot_cases_by_day('Finland', context="notebook", aspect=2.3)
    covidbot.plot_deaths_by_day('Finland', context="notebook", aspect=2.3)
