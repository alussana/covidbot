...
if __name__ == '__main__':
    ...
    covidbot.plot_data(context="notebook", figsize=(15,5))
    covidbot.plot_cases_by_day('Italy', context="notebook", aspect=2.5)
    covidbot.plot_deaths_by_day('Italy', context="notebook", aspect=2.5)
    covidbot.plot_cases_by_day('Finland', context="notebook", aspect=2.5)
    covidbot.plot_deaths_by_day('Finland', context="notebook", aspect=2.5)
